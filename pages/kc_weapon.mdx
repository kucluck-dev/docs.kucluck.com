...
Kucluck Core Weapon is a complete package for your fivem server needs.
...
- Setup your framework
  <Tabs items={["ESX", "QBCore"]}>
    <Tab>
      For ESX framework you can following this code
      ```lua copy
      Config.Core                = 'ESX'
    ...
    <Tab>
      For QBCore framework you can following this code
      ```lua copy
      Config.Core                = 'QB'
