...
Advance garages script with Fresh UI for your roleplay server
...
<Tabs items={["ESX", "QBCore"]}>
  <Tab>
    - If you don't have a `owned_vehicles` database you can add the query below to your database. If you already have one you can skip this step.
      ```sql filename="database/esx.sql" copy
      /* [[[ CREATE NEW DATABASE ]]] */
  ...
  <Tab>
    - If you don't have a `player_vehicles` database you can add the query below to your database. If you already have one you can skip this step.
      ```sql filename="database/qb.sql" copy
      /* [[[ CREATE NEW DATABASE ]]] */
    ...
    - If you are using `ox_inventory` this field is required
      ...
      /* [[[ OPTIONAL DATABASE COLUMNS ]]] */
      /* [[[ if you are using ox_inventory this field is required ]]] */
      ALTER TABLE `player_vehicles` ADD COLUMN `glovebox` LONGTEXT NULL;
      ALTER TABLE `player_vehicles` ADD COLUMN `trunk` LONGTEXT NULL;
      ```
  </Tab>
</Tabs>
